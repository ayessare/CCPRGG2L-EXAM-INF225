...
public class Regex {
    public static void main(String[] args) {
        ...
        // Provide the pattern
        pattern = Pattern.compile("^\\W[^rcfrtRCFRT]{3,}\\d$");
        ...
        pattern = Pattern.compile("^[a-zA-Z54]{10,}@gmail.com$");
        ...
        // Provide regex pattern
        pattern = Pattern.compile("\\b(https?://|www[.])[-a-zA-Z0-9.]{2,}[/a-zA-Z-]{2,}[a-zA-Z]");
        ...
        // Provide regex pattern
        pattern = Pattern.compile("\\w+(.pptx|.xlsx|.docx|.txt)");
        ...
        // Provide the regex pattern
        tweet = tweet.replaceAll("((https?|http):((//)|(\\\\))+[\\w\\d:#@%/;$()~_?\\+-=\\\\\\.&]*)", "");
